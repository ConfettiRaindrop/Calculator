...
public class UserFace extends Application implements EventHandler<ActionEvent>{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        AnchorPane.setBottomAnchor(multiplicationRect, 60.0d);
        AnchorPane.setRightAnchor(multiplicationRect, 10.0d);
        anchor.getChildren().add(divisionRect);
        AnchorPane.setBottomAnchor(divisionRect, 10.0d);
        AnchorPane.setRightAnchor(divisionRect, 10.0d);
        anchor.getChildren().add(zeroRect);
        AnchorPane.setBottomAnchor(zeroRect, 60.0d);
        AnchorPane.setRightAnchor(zeroRect, 10.0d);
        anchor.getChildren().add(oneRect);
        AnchorPane.setBottomAnchor(oneRect, 10.0d);
        AnchorPane.setRightAnchor(oneRect, 10.0d);
        anchor.getChildren().add(twoRect);
        AnchorPane.setBottomAnchor(twoRect, 60.0d);
        AnchorPane.setRightAnchor(twoRect, 10.0d);
        anchor.getChildren().add(threeRect);
        AnchorPane.setBottomAnchor(threeRect, 10.0d);
        AnchorPane.setRightAnchor(threeRect, 10.0d);
        anchor.getChildren().add(fourRect);
        AnchorPane.setBottomAnchor(fourRect, 60.0d);
        AnchorPane.setRightAnchor(fourRect, 10.0d);
        anchor.getChildren().add(fiveRect);
        AnchorPane.setBottomAnchor(fiveRect, 10.0d);
        AnchorPane.setRightAnchor(fiveRect, 10.0d);
        anchor.getChildren().add(sixRect);
        AnchorPane.setBottomAnchor(sixRect, 60.0d);
        AnchorPane.setRightAnchor(sixRect, 10.0d);
        anchor.getChildren().add(sevenRect);
        AnchorPane.setBottomAnchor(sevenRect, 10.0d);
        AnchorPane.setRightAnchor(sevenRect, 10.0d);
        anchor.getChildren().add(eightRect);
        AnchorPane.setRightAnchor(eightRect, 10.0d);
        AnchorPane.setBottomAnchor(eightRect, 10.0d);
        anchor.getChildren().add(nineRect);
        AnchorPane.setBottomAnchor(nineRect, 10.0d);
        AnchorPane.setRightAnchor(nineRect, 10.0d);
        anchor.getChildren().add(cosRect);
        AnchorPane.setBottomAnchor(cosRect, 60.0d);
        AnchorPane.setRightAnchor(cosRect, 10.0d);
        anchor.getChildren().add(sinRect);
        AnchorPane.setBottomAnchor(sinRect, 10.0d);
        AnchorPane.setRightAnchor(sinRect, 10.0d);
        anchor.getChildren().add(tanRect);
        AnchorPane.setBottomAnchor(tanRect, 60.0d);
        AnchorPane.setRightAnchor(tanRect, 10.0d);
        anchor.getChildren().add(rootRect);
        AnchorPane.setBottomAnchor(rootRect, 10.0d);
        AnchorPane.setRightAnchor(rootRect, 10.0d);
        anchor.getChildren().add(logRect);
        AnchorPane.setBottomAnchor(logRect, 60.0d);
        AnchorPane.setRightAnchor(logRect, 10.0d);
        anchor.getChildren().add(exponentRect);
        AnchorPane.setBottomAnchor(exponentRect, 10.0d);
        AnchorPane.setRightAnchor(exponentRect, 10.0d);
        anchor.getChildren().add(eRect);
        AnchorPane.setBottomAnchor(eRect, 60.0d);
        AnchorPane.setRightAnchor(eRect, 10.0d);
        anchor.getChildren().add(piRect);
        AnchorPane.setBottomAnchor(piRect, 10.0d);
        AnchorPane.setRightAnchor(piRect, 10.0d);
        anchor.getChildren().add(openParenthesesRect);
        AnchorPane.setBottomAnchor(openParenthesesRect, 60.0d);
        AnchorPane.setRightAnchor(openParenthesesRect, 10.0d);
        anchor.getChildren().add(closeParenthesesRect);
        AnchorPane.setBottomAnchor(closeParenthesesRect, 10.0d);
        AnchorPane.setRightAnchor(closeParenthesesRect, 10.0d);
        anchor.getChildren().add(punRect);
        AnchorPane.setBottomAnchor(punRect, 60.0d);
        AnchorPane.setRightAnchor(punRect, 10.0d);
        anchor.getChildren().add(translateRect);
        AnchorPane.setBottomAnchor(translateRect, 10.0d);
        AnchorPane.setRightAnchor(translateRect, 10.0d);
        anchor.getChildren().add(textboxRect);
        AnchorPane.setBottomAnchor(textboxRect, 60.0d);
        AnchorPane.setRightAnchor(textboxRect, 10.0d);
